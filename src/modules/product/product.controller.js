...
const createProduct = async (req, res) => {
    ...
    const { userId, username, fisheryName, fishName, fishCategory, price, unit, location, description, contact} = req.body;
    ...
    try {
        await bodySchema.validate({ userId, username, fisheryName, fishName, fishCategory, price, unit, location, description, contact });
